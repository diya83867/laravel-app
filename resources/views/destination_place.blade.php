@extends('layouts.package')
    @section('content')
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('../images/place-1.jpg');"
                ...
                <div class="col-lg-4 sidebar ftco-animate bg-light py-md-5">
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="project-wrap">
                            <a href="{{url('destination-place/'.$rand_destination->id)}}" class="img" style="background-image: url(../images/place-1.jpg);"></a>
                            <div class="text p-4">
