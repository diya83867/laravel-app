        ...
        <div class="row">
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="{{url('destination-place/'.$des->id)}}" class="img" style="background-image: url(images/place-1.jpg);">
        				<div class="text">
        					<h3>{{$des->title}}</h3>
        					<span>8 Days</span>
        				</div>
    ...
    <section class="ftco-section ftco-no-pt">
        ...
        <div class="row">
			...
			<div class="col-md-4 ftco-animate">
				...
				<a href="{{url('destination-place',$destination->id)}}" class="img" style="background-image: url(images/destination-2.jpg);">
						<p>
