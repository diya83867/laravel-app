...
INSERT INTO `destinations` (`id`, `pricing`, `title`, `description`, `content`, `image`, `category_id`, `published_at`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'RS 15000', 'Jaipur, Rajasthan', 'Jaipur, the vibrant capital of Rajasthan, India, seduces travelers with its rich history, colorful culture, and architectural wonders. Embark on a sensual journey through this majestic city where every corner whispers tales of royalty and romance.', 'As the sun caresses the pink-hued walls of the iconic Hawa Mahal, or Palace of Winds, its intricate latticework casts mesmerizing shadows, enticing lovers to explore its hidden chambers and secret passages.', 'destinations/1.jpeg', 1, NULL, '2024-04-04 11:06:38', '2024-04-04 11:06:38', NULL),
